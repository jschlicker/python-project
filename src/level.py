...
class Level:
	...
	def create_map(self):
		...
		graphics = {
			'grass': import_folder('../assets/environment/grass'),
			'object': import_folder('../assets/environment/objects')
		}
...
class YSortCameraGroup(pygame.sprite.Group):
	...
	def __init__(self):
		...
		# creating the floor
		self.floor_ground = pygame.image.load('../assets/tilemap/ground.png').convert()
